...
use x402_chain_eip155::{V1Eip155Exact, V1Eip155Native, V2Eip155Exact, V2Eip155Upto};
...
#[cfg(feature = "chain-eip155")]
impl X402SchemeFacilitatorBuilder<&ChainProvider> for V1Eip155Native {
    fn build(
        &self,
        provider: &ChainProvider,
        config: Option<serde_json::Value>,
        ...
        let eip155_provider = if let ChainProvider::Eip155(provider) = provider {
            ...
            return Err("V1Eip155Native::build: provider must be an Eip155ChainProvider".into());
        };
        self.build(eip155_provider, config)
    }
}
